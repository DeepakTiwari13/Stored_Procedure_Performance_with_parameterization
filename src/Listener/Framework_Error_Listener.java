...
public class Framework_Error_Listener implements IInvokedMethodListener {
	
	/* This class is used to implement the listener in TestNg */

	Logger App_log = Logger.getLogger("Framework_Error_Listener");
	// Object of log4j api has been created

	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		Reporter.setCurrentTestResult(result);
		App_log.info("*************TestsListenerAdapter******************");
